 ...
 * 
 * Implements the Supervisor Dashboard layout according to the wireframe,
 * design system rules, and green-nature theme guidelines.
 */
export default function SupervisorDashboard({ onNavigate = () => {} }) {
  ...
  const [assignedTasks, setAssignedTasks] = useState([
    ...
    { id: "TSK-202", title: "Block B02 Morning Harvest Plucking", assignee: "Nimal Siripala", role: "Worker", progress: 85, priority: "Medium" },
    { id: "TSK-203", title: "Block A02 Soil Aeration & Weed Control", assignee: "Anura Bandara", role: "Worker", progress: 30, priority: "Low" },
  ]);
  ...
  // Shortcuts items matching wireframe
  const shortcuts = [
    ...
    { id: "attendance", label: "Attendance Tracking", icon: Clock, color: "#059669", badge: "92% Today" },
  ];
          ...
          <div style={{ maxWidth: "var(--content-max-width)", margin: "0 auto" }}>
            ...
            >
              <div>
                ...
                >
                  Field Operations, Worker Allocation & Real-Time Monitoring
                </p>
              </div>
              <div className="flex-center gap-md" style={{ flexWrap: "wrap" }}>
                <div className="status-chip" style={{ background: "#FFFFFF", padding: "6px 12px" }}>
                  ...
                  <span>Field Status: <strong>Active Shift</strong></span>
                </div>
                <div className="status-chip" style={{ background: "#FFFFFF", padding: "6px 12px" }}>
            ...
            {/* --------------------------------------------------------------------
               2. MAIN DASHBOARD 3-COLUMN GRID (Matching Wireframe)
               -------------------------------------------------------------------- */}
            <div
              style={{
                display: "grid",
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-6)" }}>
                <div className="card" style={{ height: "100%" }}>
                  <div className="flex-between" style={{ marginBottom: "var(--space-4)" }}>
                    ...
                    <span className="badge-info">{workers.length} Field Workers</span>
                  </div>

                  <p className="text-muted" style={{ fontSize: "var(--fs-xs)", marginBottom: "var(--space-4)" }}>
                    Register assigned sector field workers and monitor daily estate attendance.
                  </p>
                  ...
                  <div>
                    <div className="section-title" style={{ fontSize: "var(--fs-xs)", textTransform: "uppercase", marginBottom: "var(--space-2)" }}>
                      Field Workers Under Supervision
                    </div>
              ...
              {/* ================= COLUMN 2: Manage Suppliers, Manage Tasks & Reports ================= */}
              <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-6)" }}>
                ...
                <div className="card">
                  <div className="flex-between" style={{ marginBottom: "var(--space-3)" }}>
                    ...
                    <span className="badge-info">{suppliers.length} Suppliers</span>
                  </div>
                ...
                <div className="card">
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-2)" }}>
                    <div
                      onClick={() => showToast("Downloading Sector Harvest Audit Log...")}
                      style={{
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "space-between",
                    ...
                    >
                      <span style={{ fontWeight: "var(--fw-medium)" }}>Weekly Sector Yield & Worker Performance</span>
                    ...
                    <div
                      ...
                      onMouseLeave={(e) => (e.currentTarget.style.background = "var(--color-bg)")}
                    >
                      <span style={{ fontWeight: "var(--fw-medium)" }}>Field Disease Detection & Spraying Log</span>
                      <Download size={14} color="var(--color-primary)" />
                    </div>
                  </div>
                </div>
                      ...
                      >
                        ...
                        <div className="flex-between" style={{ fontSize: "11px" }}>
                          ...
                          <button
                            ...
                            onClick={() => showToast(`Restock request dispatched for ${item.item}`)}
        ...
        <div className="modal-backdrop">
          <div className="modal-card">
            <div className="modal-header">
              <h3 style={{ fontSize: "var(--fs-md)", fontWeight: "var(--fw-bold)" }}>New Field Worker Registration</h3>
            ...
            <form onSubmit={handleAddWorker}>
              ...
              <div className="form-group">
                <label className="form-label">Assigned Block / Sector</label>
                <select
                  className="input-primary"
            ...
            <form onSubmit={handleAssignTask}>
              <div className="form-group">
                ...
                <input
                  type="text"
                  className="input-primary"
                  placeholder="e.g. Block A01 Foliar Fertilizer Application"
                  required
      ...
      {activeModal === "manageSuppliers" && (
        <div className="modal-backdrop">
          <div className="modal-card" style={{ maxWidth: 600 }}>
            <div className="modal-header">
              <h3 style={{ fontSize: "var(--fs-md)", fontWeight: "var(--fw-bold)" }}>Manage Suppliers</h3>
              <button className="btn-icon" onClick={() => setActiveModal(null)}>
                <X size={18} />
              </button>
            </div>
